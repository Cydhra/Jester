...
/// constant. It is therefore not a parameter to the `derive_key` function.
trait SymmetricKeyRatchet<K, I, O>: KeyDerivationFunction<K, I, O> {
    ...
    fn derive_key_symmetrically(derivation_key: K) -> (K, O) {
